  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" onclick="CloseView();return false;"><span aria-hidden="true">&times;</span></button>
      </div>
      ...
      <div class="modal-footer">
			<a href="#" onclick="CloseView();return false;" class="hoverBt serviceBt" title="목록보기">목록보기</a>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
