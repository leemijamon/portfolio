<%
   ...
   LMS_ID = f_arr_value(CC_KEY, CC_VALUE, "LMS_ID")
   LMS_PWD = f_arr_value(CC_KEY, CC_VALUE, "LMS_PWD")
   ...
   'LMS 잔여량 구함
   LmsCount = Lms_Count(LMS_ID,LMS_PWD)
%>
            ...
            <input type="hidden" name="cc_type" value="<%=CC_TYPE%>">
              <header>
                SMS/LMS정보
                <p class="note">SMS/LMS정보 및 관리자정보를 입력하세요. 잔여건수 : SMS <%=SmsCount%>건 / LMS <%=LmsCount%>건</p>
              </header>
              ...
              <fieldset>
                <div class="row">
                  ...
                  <section class="col col-md-4">
                    <label class="input">
                      <input type="text" name="sms_id" data-parsley-maxlength="20" data-parsley-type="alphanum" value="<%=SMS_ID%>">
                    </label>
                  </section>
                  <label class="label col col-md-2">SMS 비밀번호</label>
                  <section class="col col-md-4">
                    <label class="input">
                      <input type="text" name="sms_pwd" data-parsley-maxlength="20" value="<%=SMS_PWD%>">
                    </label>
                  </section>
                </div>
                <div class="row">
                  <label class="label col col-md-2">LMS 아이디</label>
                  <section class="col col-md-4">
                    <label class="input">
                      <input type="text" name="lms_id" data-parsley-maxlength="20" data-parsley-type="alphanum" value="<%=LMS_ID%>">
                    </label>
                  </section>
                  <label class="label col col-md-2">LMS 비밀번호</label>
                  <section class="col col-md-4">
                    <label class="input">
                      <input type="text" name="lms_pwd" data-parsley-maxlength="20" value="<%=LMS_PWD%>">
                    </label>
                  </section>
                </div>
                ...
                <div class="row">
                  ...
                  <section class="col col-md-4">
                    <label class="input"> <i class="icon-append fa fa-phone"></i>
                      <input type="tel" name="sms_site_tel" data-parsley-maxlength="15" parsley-type="phone" value="<%=SMS_SITE_TEL%>">
                    </label>
                  </section>
                </div>
              </fieldset>
