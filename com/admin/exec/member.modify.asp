...
<%
   ...
   MEM_LEVEL = MC_GROUP
   MEM_JUMIN = Trim(Request.Form("mem_jumin"))
   If MEM_JUMIN = "" Then Trim(Request.Form("mem_jumin1")) & Trim(Request.Form("mem_jumin2"))
   MEM_SEX = Trim(Request.Form("mem_sex"))
   MEM_BIRTH = Trim(Request.Form("birth_year")) & "-" & Right("00" & Trim(Request.Form("birth_month")),2) & "-" & Right("00" & Trim(Request.Form("birth_day")),2)
   ...
   MEM_MERRI_DATE = Trim(Request.Form("merri_year")) & "-" & Right("00" & Trim(Request.Form("merri_month")),2) & "-" & Right("00" & Trim(Request.Form("merri_day")),2)
   ...
   If MEM_PWD <> "" Then UPSQL = UPSQL & "MEM_PWD=N'" & MEM_PWD & "', "
